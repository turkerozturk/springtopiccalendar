...
import turkerozturk.ptt.service.TopicReportCatGrpService;
...
public class TopicReportCatGrpController {
    ...
    public TopicReportCatGrpController(AppTimeZoneProvider timeZoneProvider) {
...
*/
    ...
    public String showDoneWarnPredNeutTopics(Model model,
                                             @RequestParam(value = "categoryGroupId") Long categoryGroupId) {
        ZoneId zoneId = AppTimeZoneProvider.getZone();

        List<Topic> importants = topicReportCatGrpService.getAllUrgentTopicsSortedByMostRecentWarning(categoryGroupId);
        List<Topic> neutrals = topicReportCatGrpService.getNextNeutralTopics(neutralItemsLimit, categoryGroupId);
        List<Topic> predictions = topicReportCatGrpService.getTopicsWithPredictionDateBeforeOrEqualToday(categoryGroupId);
        List<Topic> finisheds = topicReportCatGrpService.getLastActivitiesLimitedToTodayAndThenToN(finishedItemsLimit, categoryGroupId);
